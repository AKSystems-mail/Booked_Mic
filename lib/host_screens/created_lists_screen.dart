   ...
   final bool? confirm = await showDialog<bool>(
      ...
      builder: (BuildContext dialogContext) {
         ...
         return AlertDialog(
            ...
            content: Text('Permanently delete "$listName"?\nThis cannot be undone.', style: TextStyle(color: Colors.black87)),
            actions: <Widget>[
               TextButton(
                  child: Text('Cancel'),
               ...
               TextButton(
                  child: Text('DELETE', style: TextStyle(color: deleteColor, fontWeight: FontWeight.bold)),
      ...
      appBar: AppBar(
         ...
         actions: [
            Padding(
              ...
              child: ElevatedButton.icon( // Keep styled button
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return FadeInUp(
                  ...
                  child: Card( // Removed GestureDetector
                    ...
                    child: InkWell(
                       ...
                       child: Padding(
                         ...
                         child: Column(
                           ...
                           children: [
                             Column( crossAxisAlignment: CrossAxisAlignment.start, children: [ Text(listName, style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold), maxLines: 2, overflow: TextOverflow.ellipsis), SizedBox(height: 4), Text(listData['venueName'] ?? 'No Venue', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.black54), maxLines: 1, overflow: TextOverflow.ellipsis) ]), // Using venueName as address isn't present here
